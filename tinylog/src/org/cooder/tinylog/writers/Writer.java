...
/**
 * Writers output created log entries from {@link org.cooder.tinylog.Logger Logger}.
 *
 * <p>
 * The annotation {@link org.cooder.tinylog.writers.PropertiesSupport PropertiesSupport} must be added to the implemented
 * writer class and the implemented writer must be registered as service in "META-INF/services/org.cooder.tinylog.writers"
...
public interface Writer {
	 ...
	 * registered in the <code>init()</code> method at {@link org.cooder.tinylog.writers.VMShutdownHook VMShutdownHook} for
